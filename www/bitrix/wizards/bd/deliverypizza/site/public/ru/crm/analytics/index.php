							...
							<table class="analytics-table">
								...
								foreach($sources as $key=>$source):
									...
									<tr>
										<td><?=$key?></td>
										<td><?=$source['COUNT']?></td>
										<td><?=number_format($source['SUM'],(substr_count($source['SUM'], '.') > 0) ? 2 : 0  ,'.',' ');?><span class="currency"><?=CURRENCY_FONT?></span></td>
									</tr>
								<?php endforeach; ?>
								<tr class="last">
									<td><?php echo GetMessage("all_yeah"); ?></td>
									<td><?=$local_count;?></td>
									<td><?=number_format($local_sum,(substr_count($local_sum, '.') > 0) ? 2 : 0 ,'.',' ')?><span class="currency"><?=CURRENCY_FONT?></span></td>
								</tr>
								</tbody>
							</table>
						</div>
						<div class="data-details__group">
							...
							<table class="analytics-table">
								...
								foreach($districts as $key=>$district):
									if($key == "null" || $key == 0 || !$district['NAME']) continue;
									...
									<tr>
										...
										<td><?=number_format($district['SUM'],(substr_count($district['SUM'], '.') > 0) ? 2 : 0  ,'.',' ');?><span class="currency"><?=CURRENCY_FONT?></span></td>
									</tr>
								<?php endforeach; ?>
						...
						<div class="data-details__group">
							...
							<table class="analytics-table">
								...
								foreach($pickups as $key=>$pickup):
									...
									if($key == "null" || $key == 0 || !$pickup['NAME']) continue;
									...
									<tr>
										...
										<td><?=$pickup['COUNT']?></td>
										<td><?=number_format($pickup['SUM'],(substr_count($pickup['SUM'], '.') > 0) ? 2 : 0  ,'.',' ');?><span class="currency"><?=CURRENCY_FONT?></span></td>
									</tr>
								<?php endforeach; ?>

...
<div class="order-preview">
	...
	<form id="order_form">
		...
		<input type="hidden" value="" name="ORDER_SUM"/>
				...
				<div class="customer-information">
					...
					<div class="customer-information__body">
							...
							<div class="form">
								<div class="row form-ln">
									<div class="bd-input">
                                        ...
                                        <input type="email" name="PROMO_CODE">
									</div>
								</div>
						...
						<div class="customer-information__control">
                            <div class="form-ln decline_reason_cont">
                                <div class="bd-input textarea">
                                    <label><?php echo GetMessage("decline_reason"); ?></label>
                                    <textarea rows="5" cols="5" name="DECLINE_REASON"></textarea>
                                </div>
                            </div>
		...
		<div class="row row-margin">
			<div class="client-shot-info col-my-6">
				...
				<div class="row row-margin-10">
					...
					<div class="col-my-6">
						<div class="bd-input">
							<label><?php echo GetMessage("bonus_value"); ?></label>
...
<?
    ...
    $APPLICATION->AddHeadScript(SITE_DIR.'crm/static/js/select2.full.min.js');

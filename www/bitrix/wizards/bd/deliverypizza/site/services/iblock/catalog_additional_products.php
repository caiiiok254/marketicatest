...
$iblockShortCODE = "additional_products";
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/catalog_additional_products.xml";
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_33").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["ADD_DISABLER"].'--#--'.GetMessage("BD_OPTION_34").'--,--PROPERTY_'.$arProperty["PRICE"].'--#--'.GetMessage("BD_OPTION_35").'--,--PROPERTY_'.$arProperty["COUNT"].'--#--'.GetMessage("BD_OPTION_36").'--,--PROPERTY_'.$arProperty["ADD_COUNT"].'--#--'.GetMessage("BD_OPTION_37").'--,--PREVIEW_PICTURE--#--'.GetMessage("BD_OPTION_38").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("BD_OPTION_39").'--,--PROPERTY_'.$arProperty["ELEMENTS"].'--#--'.GetMessage("BD_OPTION_40").'--,--PROPERTY_'.$arProperty["CATEGORIES"].'--#--'.GetMessage("BD_OPTION_41").'--;--;--',
	));
	// list user options

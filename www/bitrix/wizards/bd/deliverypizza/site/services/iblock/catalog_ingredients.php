...
$iblockShortCODE = "ingredients";
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/catalog_ingredients.xml";
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_42").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--CODE--#--'.GetMessage("BD_OPTION_5").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--;--;--',
	));
	// list user options

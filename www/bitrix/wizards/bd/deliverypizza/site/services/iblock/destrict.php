...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_93").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["DELIVERY_COST"].'--#--'.GetMessage("BD_OPTION_90").'--,--PROPERTY_'.$arProperty["FREE_DELIVERY"].'--#--'.GetMessage("BD_OPTION_91").'--;--;--',
	));
	// list user options

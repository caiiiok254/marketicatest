...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_80").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["STICKER"].'--#--'.GetMessage("BD_OPTION_6").'--,--PREVIEW_PICTURE--#--'.GetMessage("BD_OPTION_13").'--,--PREVIEW_TEXT--#--'.GetMessage("BD_OPTION_18").'--;--;--',
	));
	// list user options

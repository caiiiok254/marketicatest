...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_6").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["ORDER_FROM"].'--#--'.GetMessage("BD_OPTION_81").'--,--PROPERTY_'.$arProperty["COLOR"].'--#--'.GetMessage("BD_OPTION_82").'--,--PROPERTY_'.$arProperty["IDENTIFIER"].'--#--'.GetMessage("BD_OPTION_83").'--;--;--',
	));
	// list user options

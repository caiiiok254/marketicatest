...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_94").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--PROPERTY_'.$arProperty["CHANGE"].'--#--'.GetMessage("BD_OPTION_96").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["IDENT"].'--#--'.GetMessage("BD_OPTION_95").'--;--;--',
	));
	// list user options

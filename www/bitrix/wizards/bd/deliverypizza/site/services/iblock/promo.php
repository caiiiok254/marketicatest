...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_94").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--PROPERTY_'.$arProperty["USE_ONE"].'--#--'.GetMessage("BD_OPTION_97").'--,--NAME--#--'.GetMessage("BD_OPTION_98").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["DISCOUNT"].'--#--'.GetMessage("BD_OPTION_99").'--,--PROPERTY_'.$arProperty["ITEM"].'--#--'.GetMessage("BD_OPTION_100").'--,--PROPERTY_'.$arProperty["BONUS"].'--#--'.GetMessage("BD_OPTION_101").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("BD_OPTION_103").'--,--PROPERTY_'.$arProperty["AND_THE_WINNER_IS"].'--#--'.GetMessage("BD_OPTION_104").'--,--PROPERTY_'.$arProperty["GET_THIS_ALL"].'--#--'.GetMessage("BD_OPTION_105").'--,--PROPERTY_'.$arProperty["HOW_CAN_GET_IT"].'--#--'.GetMessage("BD_OPTION_106").'--;--;--',
	));
	// list user options

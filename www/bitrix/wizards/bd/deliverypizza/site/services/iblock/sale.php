...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_65").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--CODE--#--'.GetMessage("BD_OPTION_5").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["DATE"].'--#--'.GetMessage("BD_OPTION_66").'--,--PREVIEW_TEXT--#--'.GetMessage("BD_OPTION_67").'--,--PREVIEW_PICTURE--#--'.GetMessage("BD_OPTION_68").'--;--edit2--#--'.GetMessage("BD_OPTION_73").'--,--DETAIL_PICTURE--#--'.GetMessage("BD_OPTION_69").'--,--DETAIL_TEXT--#--'.GetMessage("BD_OPTION_70").'--,--PROPERTY_'.$arProperty["ADDITIONAL_PHOTOS"].'--#--'.GetMessage("BD_OPTION_71").'--,--PROPERTY_'.$arProperty["RELATED_PRODUCT"].'--#--'.GetMessage("BD_OPTION_72").'--;--;--',
	));
	// list user options

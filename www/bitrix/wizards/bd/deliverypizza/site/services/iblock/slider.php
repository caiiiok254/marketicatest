...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_74").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PREVIEW_PICTURE--#--'.GetMessage("BD_OPTION_75").'--,--DETAIL_PICTURE--#--'.GetMessage("BD_OPTION_103").'--,--PROPERTY_'.$arProperty["URL"].'--#--'.GetMessage("BD_OPTION_76").'--;--;--',
	));
	// list user options

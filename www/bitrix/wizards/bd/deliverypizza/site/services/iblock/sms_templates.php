...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_102").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["SMS_DESC"].'--#--'.GetMessage("BD_OPTION_102").'--;--;--',
	));
	// list user options

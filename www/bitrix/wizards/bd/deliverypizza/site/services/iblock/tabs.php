...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_77").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_79").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["ICON"].'--#--'.GetMessage("BD_OPTION_58").'--,--PREVIEW_TEXT--#--'.GetMessage("BD_OPTION_78").'--;--;--',
	));
	// list user options

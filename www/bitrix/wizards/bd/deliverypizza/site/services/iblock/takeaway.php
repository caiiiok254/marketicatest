...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_89").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_84").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["PHONE"].'--#--'.GetMessage("BD_OPTION_85").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("BD_OPTION_86").'--,--PREVIEW_TEXT--#--'.GetMessage("BD_OPTION_87").'--,--PROPERTY_'.$arProperty["COORDINATE"].'--#--'.GetMessage("BD_OPTION_88").'--;--;--',
	));
	// list user options

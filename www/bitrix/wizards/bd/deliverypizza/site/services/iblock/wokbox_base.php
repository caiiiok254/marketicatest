...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_59").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--PROPERTY_'.$arProperty["PRICE"].'--#--'.GetMessage("BD_OPTION_7").'--,--PROPERTY_'.$arProperty["GRAMM"].'--#--'.GetMessage("BD_OPTION_60").'--,--PREVIEW_PICTURE--#--'.GetMessage("BD_OPTION_13").'--,--PREVIEW_TEXT--#--'.GetMessage("BD_OPTION_19").'--;--;--',
	));
	// list user options

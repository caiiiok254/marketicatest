...
$iblockShortCODE = "pizza_ingredients";
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_62").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PROPERTY_'.$arProperty["AUTO_ADD"].'--#--'.GetMessage("BD_OPTION_63").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--PROPERTY_'.$arProperty["PRICE"].'--#--'.GetMessage("BD_OPTION_7").'--,--PROPERTY_'.$arProperty["GRAMM"].'--#--'.GetMessage("BD_OPTION_60").'--;--;--',
	));
	// list user options

...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("BD_OPTION_1").'--,--ACTIVE--#--'.GetMessage("BD_OPTION_31").'--,--NAME--#--'.GetMessage("BD_OPTION_4").'--,--SORT--#--'.GetMessage("BD_OPTION_32").'--,--PREVIEW_TEXT--#--'.GetMessage("BD_OPTION_19").'--,--PREVIEW_PICTURE--#--'.GetMessage("BD_OPTION_13").'--;--edit2--#--'.GetMessage("BD_OPTION_21").'--,--PROPERTY_'.$arProperty["INGREDIENTS"].'--#--'.GetMessage("BD_OPTION_64").'--;--;--',
	));
	// list user options

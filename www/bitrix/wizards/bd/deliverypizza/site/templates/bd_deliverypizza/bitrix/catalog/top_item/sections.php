...
$stickers = array();
$slides = array();
$arFilter = Array('IBLOCK_ID' => \Bd\Deliverypizza\BdCache::$iblocks[SITE_ID]["bd_content_pizza"]["bd_catalog"][0], 'DEPTH_LEVEL' => 1, 'ACTIVE' => 'Y');
$rsSections = CIBlockSection::GetList(array('SORT' => 'ASC'), $arFilter, array(), array(), array('nPageSize' => 8));
...
$arFilter = Array('IBLOCK_ID' => \Bd\Deliverypizza\BdCache::$iblocks[SITE_ID]["bd_content_pizza"]["bd_stickers"][0], 'ACTIVE' => 'Y');
...
$arFilter = Array('IBLOCK_ID' => \Bd\Deliverypizza\BdCache::$iblocks[SITE_ID]["bd_content_pizza"]["bd_catalog"][0], 'ACTIVE' => 'Y', '!PROPERTY_BANNER_URL' => false);
            ...
            <div class="common-block product-badges">
                <ul>
					<?php foreach ($stickers as $sticker): ?>
                        ...
                        $sticker_prods = array();
                        $arSelect = Array("ID");
						$arFilter = Array("IBLOCK_ID"=>\Bd\Deliverypizza\BdCache::$iblocks[SITE_ID]["bd_content_pizza"]["bd_catalog"][0], "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y",'PROPERTY_BADGES.ID'=>$sticker['ID']);
						$res = CIBlockElement::GetList(Array(), $arFilter, false, Array("nPageSize"=>50), $arSelect);
						while($ob = $res->GetNextElement())
						{

...
$arFilter = Array("IBLOCK_ID" => \Bd\Deliverypizza\BdCache::$iblocks[SITE_ID]["bd_content_pizza"]["bd_ingredients"][0], "ACTIVE_DATE" => "Y", "ACTIVE" => "Y");
...
preg_match('#/its-([a-zA-Z0-9-_]+)/#', $_SERVER['REQUEST_URI'], $matches);
$badge = $matches[1];

$arSelect = Array("ID", 'NAME');
$arFilter = Array("CODE" => $badge);
...
$APPLICATION->SetPageProperty("title", $arFields['NAME']);

if ($arParentSection = $rsParentSection->GetNext()) {
	if ($arParentSection['DEPTH_LEVEL'] == 2) {
		//$arParentSection['DEPTH_LEVEL'] = $arParentSection['DEPTH_LEVEL'] - 1;
	} else {
...
<main class="content container">
	...
	$arrFilter['IBLOCK_ID'] = \Bd\Deliverypizza\BdCache::$iblocks[SITE_ID]["bd_content_pizza"]["bd_catalog"][0];
	$arrFilter['ACTIVE'] = 'Y';
	$arrFilter['SECTION_ACTIVE'] = 'Y';
	$arrFilter['PROPERTY_BADGES.CODE'] = $badge;

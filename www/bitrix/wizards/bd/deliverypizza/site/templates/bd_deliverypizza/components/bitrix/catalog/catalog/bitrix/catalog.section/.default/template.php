...
?>
	...
	<? if ($arItem["PROPERTIES"]['BANNER']["VALUE"]): ?>
        <div class="col-lg-3 col-xl-3 col-sm-6 product-ajax-cont <?php if (isset($_GET['AJAX_PAGE'])): ?>animate<?php endif; ?>">
            <div data-id="<?= $arItem['ID']; ?>" class="product banner"
                 id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
				<?
				$preLoadPhoto = CFile::ResizeImageGet($arItem["PROPERTIES"]['BANNER']["VALUE"], array('width' => '25', 'height' => '43'), BX_RESIZE_IMAGE_EXACT, true);
				...
				$Banner3 = CFile::ResizeImageGet($arItem["PROPERTIES"]['BANNER']["VALUE"], array('width' => '344', 'height' => '465'), BX_RESIZE_IMAGE_EXACT, true);
                ...
                <a href="<?= $arItem["PROPERTIES"]['BANNER_URL']["VALUE"] ?>">
					...
					?>
                    <div class="image-tmp">
                        <source srcset="<?= CUtil::GetAdditionalFileURL($Banner5['src']); ?>"
                                media="(max-width: 554px)">
                        <source srcset="<?= CUtil::GetAdditionalFileURL($Banner4['src']); ?>"
                                media="(max-width: 768px)">
                        <source srcset="<?= CUtil::GetAdditionalFileURL($Banner3['src']); ?>"
                                media="(max-width: 991px)">
                        <source srcset="<?= CUtil::GetAdditionalFileURL($Banner2['src']); ?>"
                                media="(max-width: 1199px)">
                        <source srcset="<?= CUtil::GetAdditionalFileURL($Banner['src']); ?>"
                    ...
                    <picture>
                        ...
                        <img
                                data-full = "<?= CUtil::GetAdditionalFileURL($Banner['src']); ?>"
                                style="height: 435px;"

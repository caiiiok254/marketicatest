...
$res = CIBlockElement::GetList(Array(), Array("CODE"=>$arResult['VARIABLES']['ELEMENT_CODE']));
while($ar_res = $res->Fetch()) { $name =  $ar_res['NAME'];}
?>
<main class="content container" id="<?= $this->GetEditAreaId($arResult['ID']); ?>">
    <div class="container">
        <div class="row product product-detail product-detail-single" itemscope itemtype="http://schema.org/Product"
            ...
            <div class="breadcrumb-container font-fix">
	            <? $APPLICATION->IncludeComponent("bitrix:breadcrumb", "bread", Array('CACHE_TYPE' => 'N'), false); ?>
            </div>
        </div>

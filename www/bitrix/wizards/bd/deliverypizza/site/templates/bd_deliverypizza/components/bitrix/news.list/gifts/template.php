...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<div class="col-lg-4 col-xl-4 col-md-4 col-sm-6 col-xs-12" id="<?= $this->GetEditAreaId($arItem['ID']); ?>"
	                ...
	                <div class="gift-progress-info" data-limit="<?php echo $arItem["STICKER_GIFT"]['ORDER_FROM']; ?>" <?php if($_SESSION['BASKET_SUM_GIFT']>=$arItem["STICKER_GIFT"]['ORDER_FROM']): ?>style="display: none;" <?php endif; ?>>
		                <div class="progress-container">
			                ...
			                <div class="progress-bar-content">
				                <div
					                class="native_text"><?= GetMessage("gift_from"); ?> <?php echo number_format($arItem["STICKER_GIFT"]['ORDER_FROM'], 0, '.', ' '); ?>
					                <span class="currency"><?= CURRENCY_FONT; ?></span></div>
				                <div class="hover_text"><?= GetMessage("gift_desc"); ?> <span class="font-fix"><span
							                class="gift-progress-value"><?php echo number_format($arItem["STICKER_GIFT"]['ORDER_FROM'] - $_SESSION['BASKET_SUM_GIFT'], 0, '.', ' '); ?></span><span

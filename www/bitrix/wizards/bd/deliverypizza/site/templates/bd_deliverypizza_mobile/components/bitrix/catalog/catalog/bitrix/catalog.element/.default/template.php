     ...
     <div class="title"><?=$arResult["NAME"]?></div>
        ...
        <div class="product-detail-cont">
            ...
            <?php endif; ?>
				        ...
				        <div class="product-footer<?if($arResult["OLD_PRICE"]):?><?else:?> base-price<?endif;?>">
	                  ...
	                  <span class="old-price" <?if(!$arResult["OLD_PRICE"]):?>style="display: none;" <?endif;?>>
	                  	<span class="line-through"><?=number_format($arResult["OLD_PRICE"],(substr_count($arResult["OLD_PRICE"], '.') > 0) ? 2 : 0 ,'.',' ');?></span><span class="currency"><?=CURRENCY_FONT; ?></span>
						        ...
						        <span class="current-price"><span itemprop="price"><?=number_format($arResult["PRICE"],(substr_count($arResult["PRICE"], '.') > 0) ? 2 : 0 ,'.',' ');?></span><span class="currency"><?=CURRENCY_FONT; ?></span>

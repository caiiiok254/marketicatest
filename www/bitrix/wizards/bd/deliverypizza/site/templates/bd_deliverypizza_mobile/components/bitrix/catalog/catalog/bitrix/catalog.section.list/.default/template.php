...
<?php
				...
				if(!empty($arSection['PICTURE'])){
					...
					$preLoadPhoto =  CFile::ResizeImageGet($arSection['PICTURE'], array('width'=>'10', 'height'=>'10'), BX_RESIZE_IMAGE_EXACT, true);
				}
			?>
            <li>
            <a href="<?php echo $arSection['SECTION_PAGE_URL']; ?>"><div class="category-image">

                    <img data-full = "<?= CUtil::GetAdditionalFileURL($img['src']); ?>" src="<?=CUtil::GetAdditionalFileURL($preLoadPhoto['src'])?>"  alt="<?=$last_product["PREVIEW_PICTURE"]["ALT"]?>" title="<?=$last_product["PREVIEW_PICTURE"]["TITLE"]?>" class="progressiveLoad" width="100"
					/>
